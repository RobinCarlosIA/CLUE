...
# -*- coding: utf-8 -*-
"""
CLUE (Consola, Español) — 5x5x5 con finales enlazados (más realista)
Nombres fijos: Robin, Fernanda, Luis, Emiliano, Juan
Armas fijas: Cuchillo, Pistola 9mm, Cuerda, Veneno, Barra metálica
Python 3.8+

Ejecución:
    python clue_realista.py
"""
...
# ------------------------------------------------------------------
# Sospechosos (profesiones reales)
# ------------------------------------------------------------------
SUSPECTOS = [
...
# ------------------------------------------------------------------
# Locaciones (coherentes con contextos reales)
# ------------------------------------------------------------------
LOCACIONES = [
...
# ------------------------------------------------------------------
# Pistas y detalles técnicos (enlaces a arma/lugar)
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# Finales (5 historias enlazadas por culpable + arma + locación)
# ------------------------------------------------------------------
